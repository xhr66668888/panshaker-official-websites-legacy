...
(function (global) {
    ...
    var SYNAPSE_INLINE_PACKS = {
        ...
        'en': {
            ...
            'synapse.stories.desc': 'See how restaurants improve efficiency and profitability with PanOS.',
            ...
            'synapse.screens.title': 'Experience the Power of PanOS',
            'synapse.screens.desc': 'End-to-end intelligent management from order to serving.',
            'synapse.screens.item1.title': 'AI Nerve Center',
            'synapse.screens.item1.desc': 'Use natural language to handle complex requests instantly. The AI assistant parses orders, identifies table numbers, and dispatches tasks to kitchen robots in real time.',
            'synapse.screens.item2.title': 'Real-Time Dashboard',
            'synapse.screens.item2.desc': 'View your full operations on one screen: orders, revenue, average ticket, and completion rate—refreshed in real time for smarter decisions.',
            'synapse.screens.item3.title': 'Panshaker Smart Wok',
            'synapse.screens.item3.desc': 'Monitor robot status in real time with oil temperature precision down to 0.1°C. Direct G-Code dispatch ensures standardized output for every dish.',
            'synapse.screens.item4.title': 'Delivery Aggregation Platform',
            'synapse.screens.item4.desc': 'Manage all delivery orders in one interface. Seamless integration with mainstream platforms enables auto-accept and smart dispatch.',
            'synapse.screens.item5.title': 'Flavor Digital Twin',
            'synapse.screens.item5.desc': 'Build personalized flavor profiles per customer, recording spice, salt, and oil preferences for true C2M customization.',
